    ...
    export default {
        ...
        methods: {
          success(row,index){
            ...
            // this.$http({
            //   url:'http://39.106.9.139/apis/restful/add/_linked/user_to_company_staff',
            //   method:'POST',
            //   headers: {
            ...
            //       //发送信息
            //       this.$http({
            //         url:'http://39.106.9.139/apis/restful/del/_message/company_staff_link('+row.infor_id+')',
            //         method:'POST',
            //         headers: {
            //           'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
            //         },
          ...
          getInfor(){
            ...
            //   }).then(
            //     res =>{
            //       this.company_list = res.data.values;
            //       // console.log(this.company_list)
            //       this.$http({
            //         url:'http://39.106.9.139/apis/restful/list/_message/company_staff_link',
            //         method:'POST',
            //         headers: {
            //           'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
            //         },
            ...
            //                 if(res.data.values[i].status == "wait"){
            //                   // this.tableData5.push()
            //                   for(var j = 0;j < this.company_list.length; j++){

            //                     if(this.company_list[j].id == res.data.values[i].company_id){
            //                       this.tableData5.push(
            //                         {
            //                           infor: '是否与 '+this.company_list[j].name+' 公司进行关联?',
            //                           company_id: res.data.values[i].company_id,
            //                           staff_id: res.data.values[i].staff_id,
            //                           infor_id: res.data.values[i].id
            //                         }
            //                       )
